...
## Structure
```
RSE-Go-Chase-It                    # Go Chase It Project
...
$ git clone https://github.com/diyaeldin/RSE-Go-Chase-It.git
$ mv RSE-Go-Chase-It src
...
5. Move the white ball and place in front of the mobile robot. The robot should start follow the ball.
